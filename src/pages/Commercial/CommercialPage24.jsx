...
export default function CommercialPage24() {
    ...
    <div className="w-full min-h-screen bg-[#eef2f7] flex justify-center py-8">
      <div className="w-[1150px] bg-white border border-[#d9d9d9] shadow-lg px-[40px] pt-[25px] pb-[60px]">
        ...
        {pageData ? (
          ...
          <div className="mt-6 text-[13px] text-gray-400 italic">No data found for page 24. Check commercialPages19to24Data.js.</div>
        )}
        ...
        <div className="mt-8 flex justify-between items-end text-[10px] italic text-[#8d8d8d]">
          ...
          <div className="text-right">
            ...
            <p className="text-[#003f77] font-semibold not-italic mt-1">Page 24 of 24</p>
          </div>
        </div>

        {/* NAVIGATION — Export Full Proposal (all 24 pages) */}
        <div className="flex justify-center mt-8">
          <ExportButton
            type="commercial"
            label="Export Full Proposal PDF"
          />
        </div>
